...
class Students extends Controller
{
  ...
  {
    $data = $this->model('Students_Model')->getStudentById($_POST['id']);
  ...
  public function setUpdate()
  {
    ...
    $updateData =  $this->model('Students_Model')->updateStudent($_POST);
    if ($updateData > 0) {
      Flasher::setFlasher('success', 'update', 'success');
      header('Location: ' . BASEURL . '/Students');
      exit();
    } else {
      Flasher::setFlasher('failr', 'delete', 'danger');
